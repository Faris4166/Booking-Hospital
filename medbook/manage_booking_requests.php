                                ...
                                <div id="filterDropdown"
                                    ...
                                    <ul class="space-y-2 text-sm" aria-labelledby="filterDropdownButton">
                                        <li class="flex items-center">
                                            ...
                                            <label for=""
                                                class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-100">อนุญาติการจองแล้ว</label>
                                        </li>
                                        <li class="flex items-center">
                                            <input id="" type="checkbox" value=""
                                                class="w-4 h-4 bg-gray-100 border-gray-300 rounded text-primary-600 focus:ring-primary-500 dark:focus:ring-primary-600 dark:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500">
                                            <label for=""
                                                class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-100">ไม่อนุญาติการจองแล้ว</label>
                                        </li>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            <thead
                                ...
                                <tr>
                                    <th scope="col" class="px-4 py-4">Room</th>
                            ...
                            <tbody>
                                <tr class="border-b dark:border-gray-700">
                                    ...
                                    <td class="px-4 py-3">ไม่บอก
                                    <td class="px-4 py-3 max-w-[12rem] truncate">ไม่บอก</td>
                                    <td class="px-4 py-3">ไม่บอก</td>
                                    <td class="px-4 py-3">ไม่บอก</td>
                                    <td class="px-4 py-3">ไม่บอก</td>
                                    <td class="px-4 py-3">ไม่บอก</td>
                ...
                <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                    ...
                    <form action="#">
                        <div class="grid gap-4 mb-4 sm:grid-cols-2">
                            ...
                            <div>
                                <label for="Create At"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Create At</label>
                                <input type="text" name="text" id="text"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                    placeholder="" required="">
                            </div>
                            <div class="sm:col-span-2"><label for="notes"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">notes</label><textarea
