...
<div class="sm:ml-64 mt-10">
    <div class="w-full max-w-7xl bg-white rounded-xl shadow-lg p-6">
        ...
        <div class="flex items-center justify-between mb-4">
            <h1 class="text-2xl font-bold">รายชื่อห้อง</h1>
            <!-- ปุ่มเปิด modal -->
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-100">
                    <tr>
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-600 uppercase tracking-wider">Room ID</th>
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-600 uppercase tracking-wider">Room Name</th>
                        ...
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-600 uppercase tracking-wider">Capacity</th>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    <?php while ($row = $result->fetch_assoc()): ?>
                        <tr>
                            <td class="px-6 py-2"><?= htmlspecialchars($row['room_id']) ?></td>
                            <td class="px-6 py-2"><?= htmlspecialchars($row['room_name']) ?></td>
                            <td class="px-6 py-2">
