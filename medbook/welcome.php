...
<div class="min-h-screen flex items-center justify-center bg-gray-50 p-4 sm:ml-64 mt-10">
  <div class="max-w-4xl w-full px-1 py-10 space-y-8">
    ...
    <div class="flex flex-col md:flex-row md:space-x-6 space-y-4 md:space-y-0 justify-center">
      <!-- จองห้อง -->
      <div class="flex-1 bg-blue-100 hover:bg-blue-200 transition rounded-2xl shadow p-6 text-center cursor-pointer max-w-md mx-auto">
      ...
      <!-- ดูประวัติ -->
      <div class="flex-1 bg-green-100 hover:bg-green-200 transition rounded-2xl shadow p-6 text-center cursor-pointer max-w-md mx-auto">
