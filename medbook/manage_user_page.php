...
<body class="bg-gray-900">
    <div class="sm:ml-64 mt-10">
        <!-- Start block -->
        <section class="bg-gray-50 bg-gray-900 p-10 antialiased">
            <div class="mx-auto max-w-screen-xl px-4 lg:px-12 sm:">
                <!-- Start coding here -->
                                ...
                                <div id="filterDropdown"
                                    ...
                                    <ul class="space-y-2 text-sm" aria-labelledby="filterDropdownButton">
                                        <li class="flex items-center">
                                            ...
                                            <label for=""
                                                class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-100">ยืนยันบัญชีแล้ว</label>
                                        </li>
                                        <li class="flex items-center">
                                            <input id="" type="checkbox" value=""
                                                class="w-4 h-4 bg-gray-100 border-gray-300 rounded text-primary-600 focus:ring-primary-500 dark:focus:ring-primary-600 dark:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500">
                                            <label for=""
                                                class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-100">ไม่ยืนยันบัญชี</label>
                                        </li>
                                        <li class="flex items-center">
                                            <input id="" type="checkbox" value=""
                                                class="w-4 h-4 bg-gray-100 border-gray-300 rounded text-primary-600 focus:ring-primary-500 dark:focus:ring-primary-600 dark:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500">
                                            <label for=""
                                                class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-100">นักศึกษา</label>
                                        </li>
                                        <li class="flex items-center">
                                            <input id="" type="checkbox" value=""
                                                class="w-4 h-4 bg-gray-100 border-gray-300 rounded text-primary-600 focus:ring-primary-500 dark:focus:ring-primary-600 dark:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500">
                                            <label for=""
                                                class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-100">ครู</label>
                                        </li>
                                </div>
                            </div>
                        </div>
                        ...
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            <thead
                                ...
                                <tr>
                                    ...
                                    <th scope="col" class="px-4 py-3">LINE ID</th>
                                    <th scope="col" class="px-4 py-3">Phone Number</th>
                                    <th scope="col" class="px-4 py-3">Eamil</th>
                                    <th scope="col" class="px-4 py-3">Role</th>
                                    <th scope="col" class="px-4 py-3">Verification</th>
                            ...
                            <tbody>
                                <tr class="border-b dark:border-gray-700">
                                    <th scope="row"
                                        ...
                                        Faris&#34;</th>
                                    <td class="px-4 py-3">faris</td>
                                    <td class="px-4 py-3">0650188390
                                    <td class="px-4 py-3 max-w-[12rem] truncate">mail.gaamil.com</td>
                                    <td class="px-4 py-3">ไม่บอก</td>
                                    <td class="px-4 py-3">ไม่บอก</td>
            ...
            <div class="relative p-4 w-full max-w-2xl max-h-full">
                ...
                <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                    ...
                    <div
                        ...
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Add Username</h3>
                        <button type="button"
                    ...
                    <form action="#">
                        <div class="grid gap-4 mb-4 sm:grid-cols-2">
                            ...
                            <div>
                                <label for="password"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">ยืนยัน password
                                </label>
                                <input type="password" name="password" id="password"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                    placeholder="" required="">
        ...
        <div id="updateProductModal" tabindex="-1" aria-hidden="true"
            ...
            <div class="relative p-4 w-full max-w-2xl max-h-full">
                ...
                <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                    ...
                    <div
                        class="flex justify-between items-center pb-4 mb-4 rounded-t border-b sm:mb-5 dark:border-gray-600">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Update Username</h3>
                        <button type="button"
                            class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white"
                            data-modal-toggle="updateProductModal">
                            <svg aria-hidden="true" class="w-5 h-5" fill="currentColor" viewbox="0 0 20 20"
